...
// Je ne pense pas que vous vouliez 0 en moyenne, remplacez par le bon calcul
...
$prix_ttc = $prix_ht*(1+$tva/100);
 // Non le total n'est pas gratuit, remplacez par le bon calcul
echo $prix_ttc; "Le prix TTC du produit est de " . $prix_ttc . "€.\n";
